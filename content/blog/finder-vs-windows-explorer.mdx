...
tags: ["files"]
faq:
  - q: "What is the Mac equivalent of File Explorer?"
    a: "Finder. It is the blue smiling-face icon at the start of the Dock, and it does the same job as Windows Explorer with a slightly different layout."
  - q: "Where is the address bar in Finder?"
    a: "It is hidden by default. Turn on the Path Bar with View > Show Path Bar, or press Option+Cmd+P. To type a path and jump to it, use Shift+Cmd+G."
  - q: "How do I connect to a network drive on a Mac?"
    a: "In Finder, use Go > Connect to Server, or press Cmd+K, then enter the IP or .local address. Once mounted, it appears in the sidebar and you eject it with Cmd+E."
  - q: "How do I preview a file without opening it?"
    a: "Select the file and press the spacebar. That is Quick Look, an instant full-size preview that works on images, PDFs, video, and most documents."
---
